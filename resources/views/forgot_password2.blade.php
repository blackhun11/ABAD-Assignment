        ...
        <div class="col-xl-4 push-xl-4 col-lg-6 push-lg-3 col-md-8 push-md-2 col-sm-8 push-sm-2 col-10 push-1">
            <div class="row">
                <div class="col-lg-10 push-lg-1 col-md-10 push-md-1 col-sm-12 login_image login_section forgot_section_top">
                    ...
                    <div class="m-t-15">
                        <form action="{{URL::to('forgot_password2')}}"  id="login_validator1" method="post" class="form-group  login_validator bv-form" novalidate="novalidate">
                            <div class="login_content login_border_radius">
                                ...
                                <div class="form-group text-center">
                                    <a type="submit" class="btn btn-mint submit_email b_r_20 login_button m-t-10" href="{{URL::to('login2')}}" >Submit
                                    </a>
                                </div>
                            </div>
                        </form>
