                                        ...
                                        <div id="rootwizard">
                                            ...
                                            <div class="tab-content m-t-20">
                                                <div class="tab-pane" id="tab1">
                                                    <div class="form-group">
                                                        <label for="userName" class="col-form-label">User
                                                            name *</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="confirm" class="col-form-label">Confirm
                                                            Password
                                                            *</label>
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    <div class="form-group">
                                                        <label for="name1" class="col-form-label">First name
                                                            *</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="surname1" class="col-form-label">Last
                                                            name *</label>
